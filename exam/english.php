...
$query = "SELECT * FROM exam WHERE subject =2 LIMIT $limit OFFSET $offset";
$result = $conn->query($query);

$total_query = "SELECT COUNT(*) AS total_questions FROM exam WHERE subject =2";
...
while ($row = $result->fetch_assoc()) {
  ...
  echo "<input type='hidden' name='question_id' value='".$row['id']."' id='question_id'>";
   echo "<input type='hidden' name='subject_id' value='".$row['subject']."' id='subject_id'>";
     echo "<input type='hidden' name='subject' value='english' id='subject'>";
...
<p><a href="result.php?subject=2">End Exam</a></p>
</div>
<br>
<hr><br>
