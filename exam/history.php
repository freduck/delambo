...
$query = "SELECT * FROM exam WHERE subject =11 LIMIT $limit OFFSET $offset";
$result = $conn->query($query);

$total_query = "SELECT COUNT(*) AS total_questions FROM exam WHERE subject =11";
...
while ($row = $result->fetch_assoc()) {
  ...
  echo "<ul>";
  echo "<li><input type='radio' name='answer' value='".$row['option_1']."' id='answer' required> A. " . $row['option_1'] . "</li>";
  echo "<li><input type='radio' name='answer' value='".$row['option_2']."' id='answer' required> B. " . $row['option_2'] . "</li>";
  echo "<li><input type='radio' name='answer' value='".$row['option_3']."' id='answer' required> C. " . $row['option_3'] . "</li>";
  echo "<li><input type='radio' name='answer' value='".$row['option_4']."' id='answer' required> D. " . $row['option_4'] . "</li>";
  echo "</ul>";
  ...
  echo "<input type='hidden' name='question_id' value='".$row['id']."' id='question_id'>";
   echo "<input type='hidden' name='subject_id' value='".$row['subject']."' id='subject_id'>";
     echo "<input type='hidden' name='subject' value='history' id='subject'>";
...
<p><a href="result.php?subject=11">End Exam</a></p>
</div>
<br>
<hr><br>
